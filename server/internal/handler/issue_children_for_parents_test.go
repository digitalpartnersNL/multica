...
func newScrambledChildren(t *testing.T) (IssueResponse, []IssueResponse) {
	...
	// Mixed statuses are the point of this fixture; backlog keeps the mix
	// without tripping the I4127 in_progress-requires-assignee gate.
	c2 := createChildIssue(t, "ordering c2", "backlog", parent.ID)
